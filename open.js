module.exports = {
    ...
    ejecutar: async (sock, msg, args) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: '🔓 *Grupo Abierto:* Ya pueden hablar, mortales. _Que comience el caos._ 🪩' }, { quoted: msg });
        } catch (error) {
            console.error(error);
            await sock.sendMessage(from, { text: '❌ *Error:* No pude abrir el grupo. Verifica que yo sea admin.' }, { quoted: msg });
        }
    }
}